...
=======
//#endif
>>>>>>> 63760de1d13e631c8fa3e1f8b54a6b8e96ba21cc
...
=======
        ...
        #else
        DMABuffersTampon[0]->next = DMABuffersTampon[1];
        DMABuffersTampon[1]->next = DMABuffersTampon[0];
        DMABuffersTampon[2]->next = DMABuffersTampon[0];
        DMABuffersTampon[3]->next = NULL;
        #endif
        dmaBufferActive = 0;
